...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Panel2, 204);
    lv_obj_set_height(ui_Panel2, 221);
    ...
    lv_obj_set_width(ui_RPM_Monitor_Container, 173);
    lv_obj_set_height(ui_RPM_Monitor_Container, 195);
    ...
    lv_obj_set_width(ui_RPM_R_Container, 75);
    lv_obj_set_height(ui_RPM_R_Container, 123);
    ...
    lv_obj_set_style_text_font(ui_RPM_L, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_RPM_L_Text, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Current_RPM_L, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Current_RPM_L_Text, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_RPM_Warning = lv_obj_create(ui_RPM_Monitor_Container);
    lv_obj_set_width(ui_RPM_Warning, 15);
    lv_obj_set_height(ui_RPM_Warning, 15);
    ...
    lv_obj_set_width(ui_RPM_L_Container, 75);
    lv_obj_set_height(ui_RPM_L_Container, 123);
    ...
    lv_obj_set_style_text_font(ui_RPM_R, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_RPM_R_Text, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Current_RPM_R, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Current_RPM_R_Text, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Panel1 = lv_obj_create(ui_Screen1);
    lv_obj_set_width(ui_Panel1, 115);
    lv_obj_set_height(ui_Panel1, 221);
    ...
    lv_obj_set_width(ui_Battery_and_Sola_Panel_Container, 105);
    lv_obj_set_height(ui_Battery_and_Sola_Panel_Container, 123);
    ...
    lv_obj_set_style_text_font(ui_Battery_Value, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Battery_Text, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Solar_Panel_Value, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Solar_Panel_Text, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Panel3 = lv_obj_create(ui_Screen1);
    lv_obj_set_width(ui_Panel3, 317);
    lv_obj_set_height(ui_Panel3, 19);
