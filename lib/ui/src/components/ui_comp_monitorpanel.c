...
lv_obj_t * ui_MonitorPanel_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_width(cui_MonitorPanel, 62);
    lv_obj_set_height(cui_MonitorPanel, 27);
    ...
    lv_obj_set_style_bg_color(cui_MonitorPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
